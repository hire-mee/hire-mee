  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className='stat_info'>You applied to <span className='stat_color'>{this.props.user.appliedmonth/4}</span> jobs on a weekly average.</div>
        ...
        <div className="stat_pie">
          ...
          />
          <a className='stat_pieInfo'>Status on <span className='stat_color'>{this.props.user.totalapplied}</span> applications.</a>
        </div>
      </div>
    )
  }
